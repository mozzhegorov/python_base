...
prime_number_iterator = iter(PrimeNumbers(n=100))       # TODO: убираем iter(), но и название объект тоже меняем)
...
# TODO: явно получать итератор не нужно. Иногда нужно, но не в этом случае.
#  .
