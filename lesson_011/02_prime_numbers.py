...
prime_number_iterator = iter(PrimeNumbers(n=100))
...
vot_eto_iterator = iter(
    prime_number_iterator)  # здесь произойдет вызов __iter__, настройка полей и вернется тот же объект, но уже готовый к итерированию
