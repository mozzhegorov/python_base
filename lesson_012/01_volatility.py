...
#     def run(self):
#         <обработка данных>
import glob     # TODO: как лучше импортировал glob?
# TODO: проведем аналогию. Допустим мы хотим импортировать модуль math. Представим, что math - это холодильник. А все
...
# TODO: понял. Можете поставить lesson_012 как ROOT + импортировать time_track из python_snippets.utils.py?
#  Тогда мы не будет копировать код))
...
# TODO: значит функцию можно удалить?
