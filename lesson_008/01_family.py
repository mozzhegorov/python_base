...
class Creature:
    ...
    #   ОТВЕТ: да, идея была в жтой ситуации. С другой стороны сейчас понял что в принципе и дом и имя и
    #   прожорливость такого же типа параметры. Переименовал. Надеюсь зачтется.
