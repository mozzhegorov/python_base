...
# TODO: давайте добавим "draw_", т.к. название ф-ций и метод должно быть глаголами или сказуемыми.
def smile(x, y, color):
...
for _ in range(10):
    ...
    # TODO: Ответ. Согласен, тогда можете оставить свой способ. Аргументировали почему он лучше, я согласен.
