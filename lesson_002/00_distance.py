...
#  С точки зрения результата - словарь получился правильный. Можно сделать некоторые улучшения.
...
#  Второй способ (более удобный для чтения)
...
#     }
# }
#  по итогу оба словаря равны, но внутренности второго видны, а первого - нет.
# print(d_1 == d_2)
#  задача - сделать создание словаря вторым способом)
...
distances = {
    'Москва': {
        'Лондон': moscow_london,
        'Париж': moscow_paris
    },
    'Лондон': {
        'Москва': moscow_london,
        'Париж': london_paris
    },
    'Париж': {
        'Лондон': london_paris,
