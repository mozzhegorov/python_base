...
# TODO: Второй способ (более удобный для чтения)
...
#  distances['Москва']['Париж']
#  distances['Париж']['Москва']        # оба доступны
#  .
...
distances = {
    'Москва': {
        'Лондон': 0,        # TODO: использовать переменные, чтобы инициализировать словарь при его создании.
        'Париж': 0          #  Обратите внимание, что предварительно создавать его через dict() не нужно.
    },
    'Лондон': {
        'Москва': 0,
        'Париж': 0
...
# TODO: это шаг №1. Посчитать расстояния между городами, сохранить в отдельные переменные.
distances['Москва']['Лондон'] = distances['Лондон']['Москва'] = ((moscow[0] - london[0]) ** 2 + (moscow[1] - london[1]) ** 2) ** .5
distances['Москва']['Париж'] = distances['Париж']['Москва'] = ((moscow[0] - paris[0]) ** 2 + (moscow[1] - paris[1])
                                                               ** 2) ** .5
distances['Лондон']['Париж'] = distances['Париж']['Лондон'] = ((london[0] - paris[0]) ** 2 + (london[1] - paris[1]) ** 2) ** .5
