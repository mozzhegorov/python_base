...
while True:
    ...
    while num_of_bulls < 4:
        ...
        # TODO: правки применимые к циклу ниже
        #  1. убираем while True ниже;
        #  2. убираем break;
        #  3. в случае ошибки добавляем к print`у еще и continue.
        while True:
            my_num = input()
            # проверяем что пользователь ввел допустимое число (4 цифры, все цифры разные, не начинается с 0)
        ...
        # TODO: используйте "!=" вместо "==", тогда станет очевидно, как упростить 1 ветку
