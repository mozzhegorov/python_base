...
def make_number():
    ...
    # main_number = str(randint(1, 9))      # TODO: это же был крутой рабочий способ, способ выше подразумевает создание
...
def check_right(number):
    # TODO: number это число/строка/список?
    #  Попробуйте при отгадывании ввести число "1111".
    if len(set(number)) < 4 and number < 1000:
        return False
    return True

    # TODO: у нас должны быть проверки для случае:
